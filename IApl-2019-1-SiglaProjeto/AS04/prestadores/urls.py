...
urlpatterns = [
    ...
    path('delete_person/<int:person_id>/', views.update_person, name='update_person'),
    ...
    path('delete_supplier/<int:supplier_id>/', views.update_supplier, name='update_supplier'),
    ...
    path('delete_expertise/<int:expertise_id>/', views.update_expertise, name='update_expertise'),
